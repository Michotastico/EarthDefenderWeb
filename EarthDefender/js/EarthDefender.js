...
var background_music = new Howl({
    src: ['EarthDefender/audio/background.mp3'],
    autoplay: true,
    loop: true
});

var pew_sound = new Howl({
    src: ['EarthDefender/audio/laser.wav']
});
...
function setup() {
    ...
    images = resources["EarthDefender/images/images.json"].textures;
    ...
    var left = keyboard(37),
        right = keyboard(39),
        space = keyboard(32),
        restart_key = keyboard(82);

    restart_key.press = function(){
        if (lives <= 0){
            lives = 6;
